...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderVO getOrderVOBySalAndSao(Sal sal, Sao sao) {
        return new OrderVO(sao.getSaoId(),sal.getProId(),proRepository.getProByProId(sal.getProId()).getTitle(),sal.getPrice(),sal.getQty(),proRepository.getProByProId(sal.getProId()).getSkuCd(),sao.getOrderNo(),sal.getPrice().multiply(new BigDecimal(sal.getQty())),sal.getTrackingNo());
    }
